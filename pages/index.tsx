          ...
          <div>
            <div className={styles.servicestext}>
              ...
              <div className="d-flex justify-content-center">
                <h3 className={styles.servicesubtext}>
        ...
        <div>
          <div className={`${styles.fifth}  row align-items-center`}>
            ...
            <div className="col-12 col-lg-6 align-items-center justify-content-center">
              <h3 className={styles.fifthheader}>
              ...
              <div className="my-4 ">
                <div className={`${styles.points}`}>
                  ...
                  <p className="my-0 py-0 mx-0 px-3">
                ...
                <div className={`${styles.points}`}>
                  <IoCheckmarkCircle className={styles.goodicon} />
                  <p className="my-0 py-0 mx-0 px-3">
                    Business-to-consumer long tail busines.
                  </p>
                </div>
              ...
              <div>
                <div className="d-flex align-items-center my-2">
                  <div className={styles.box}>
                    <FiFeather />
                    <p className={`${styles.bo} my-0 py-0 mx-0 px-3`}>
                      We connect our customers with the best.
                    </p>
                  </div>
                </div>
            ...
            <div className="col-12 col-lg-6 ">
              <div>
                <div className="d-flex align-items-center my-2 justify-content-end ">
                  <p className="my-0 pb-2 mx-0 px-3">
                    We connect our customers with the best?
                  </p>
                ...
                {showDropdown1 && (
                  <div className={`${styles.faq} `}>
                    <p>Here is a frequently asked question</p>
                  </div>
                )}
        ...
        <div className={styles.sectionseven}>
          <div>
            <div className={styles.servicestext}>
              ...
              <div className="d-flex justify-content-center">
                <h3 className={styles.blogsubtext}>
            ...
            <div className={styles.servicegrid}>
              <div className={styles.eachgrid}>
                ...
                <div className={`${styles.blogtexts}`}>
                  <p className="mx-0 my-0 py-0">
                    Pitch termsheet backing validation focus release.
                  </p>
                </div>
                <div
                  className={`${styles.respblog} d-flex align-items-center my-3`}
                >
                  <Image
                    src="/pic1.png"
                    alt="logoone"
